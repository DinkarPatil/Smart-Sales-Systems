...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    if (!token) setError("This link is invalid or has expired. Please request a new one.");
  }, [token]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(extractError(err, "Couldn't update your password. Please try again."));
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-black text-white tracking-tight">
            Set a <span className="text-accent-secondary italic">new password</span>
          </h2>
        ...
        <div className="bg-amethyst-950/40 backdrop-blur-3xl rounded-[2.5rem] border border-white/5 shadow-2xl p-8 lg:p-10 relative overflow-hidden">
          ...
          <div className="mb-8">
            <h3 className="text-xl font-bold text-white tracking-tight">Choose a new password</h3>
          ...
          <AnimatePresence mode="wait">
            ...
            {success ? (
              ...
              >
                ...
                <h4 className="text-lg font-bold text-white mb-2 italic">Password updated</h4>
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  You can now sign in with your new password.
                </p>
                <p className="text-accent-secondary text-[9px] font-black uppercase tracking-[0.25em] animate-pulse">
